...
const exampleArr2 = [4, 3, 2, 1]

assert.strictEqual(maximumTrailing(exampleArr1), 4)
assert.strictEqual(maximumTrailing(exampleArr2), -1)
...
class TestPromise {
  constructor(value) {
    this.testPromise = Promise.resolve(value)
  }
}
...
const order1 = [1, 4, 2, 3]

sequentialResolution(promises1, order1)
